...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{asset('Home/assets/css/templatemo-style.css') }}">
		<script src="{{asset('Home/assets/js/jquery.js') }}"></script>
		<script src="{{asset('Home/assets/js/bootstrap.min.js') }}"></script>
        <script src="{{asset('Home/assets/js/jquery.singlePageNav.min.js') }}"></script>
		...
		<nav class="navbar navbar-default templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">SMK WIKRAMA BOGOR</a>
				</div>
    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-md-offset-2 col-md-8">
    					<h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s" style="color : white"><b>Smk Wikrama Bogor</h1>
    					<div class="element">
                            <div class="sub-element">ILMU ILMIAH</div>
                            <div class="sub-element">AMAL AMALIAH</div>
                            <div class="sub-element">AKHLAKUL KHARIMAH</div>
                        </div>
    					<a data-scroll href="/siswa" class="btn btn-default wow fadeInUp" data-wow-offset="50" data-wow-delay="0.6s" >DAFTAR SEKARANG</a>
    				</div>
    			...
    			<div class="row">
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.3s">
    					<div class="team-wrapper">
    						<img src="{{asset('Home/assets/images/team-img1.jpg') }}" class="img-responsive" alt="team img 1">
    							<div class="team-des">
    								<h4>TRACY</h4>
    								<span>Designer</span>
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.6s">
    					<div class="team-wrapper">
    						<img src="{{asset('Home/assets/images/team-img2.jpg') }}" class="img-responsive" alt="team img 2">
    							<div class="team-des">
    								<h4>MARY</h4>
    								<span>Developer</span>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et laoreet phasellus ut nisi id leo molest.</p>
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.3s">
    					<div class="team-wrapper">
    						<img src="{{asset('Home/assets/images/team-img3.jpg') }}" class="img-responsive" alt="team img 3">
    							<div class="team-des">
    								<h4>JULIA</h4>
    								<span>Director</span>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et laoreet phasellus ut nisi id leo molest.</p>
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.6s">
    					<div class="team-wrapper">
    						<img src="{{asset('Home/assets/images/team-img4.jpg') }}" class="img-responsive" alt="team img 4">
    							<div class="team-des">
    								<h4>LINDA</h4>
    								<span>Manager</span>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et laoreet phasellus ut nisi id leo molest.</p>
    			...
    			<div class="row">
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
    					   <img src="{{asset('Home/assets/images/portfolio-img1.jpg') }}" class="img-responsive" alt="portfolio img 1">
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
                           <img src="{{asset('Home/assets/images/portfolio-img2.jpg') }}" class="img-responsive" alt="portfolio img 2">
                                <div class="portfolio-overlay">
                                    <h4>Project Two</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget dia.</p>
                                    <a href="#" class="btn btn-default">DETAIL</a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
                           <img src="{{asset('Home/assets/images/portfolio-img3.jpg') }}" class="img-responsive" alt="portfolio img 3">
                                <div class="portfolio-overlay">
                                    <h4>Project Three</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget dia.</p>
                                    <a href="#" class="btn btn-default">DETAIL</a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                        <div class="portfolio-thumb">
                           <img src="{{asset('Home/assets/images/portfolio-img4.jpg') }}" class="img-responsive" alt="portfolio img 4">
                                <div class="portfolio-overlay">
                                    <h4>Project Four</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget dia.</p>
                                    <a href="#" class="btn btn-default">DETAIL</a>
    			...
    			<div class="row">
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<p><i class="fa fa-phone"></i> 0251-8242411</p>
    						<p><i class="fa fa-envelope-o"></i> smkwikrama@company.com</p>
